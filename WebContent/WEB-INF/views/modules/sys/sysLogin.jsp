...
<head>
	...
	<link rel="stylesheet" href="${ctxStatic}/verify/css/verify.css">
...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/login" method="post" onsubmit="return isok">
...
<%--		验证码--%>
		<div id="validateCode" style="margin-top: 20px" class="required"></div>
<%--		<button type="button" id="check-btn2" class="verify-btn">确定</button>--%>
<%--		<br>--%>
	<%--
		<label for="mobile" title="手机登录"><input type="checkbox" id="mobileLogin" name="mobileLogin" ${mobileLogin ? 'checked' : ''}/></label> --%>
		<input class="btn btn-large btn-primary" id="check-btn2" type="submit" value="登 录" />
	...
	<script type="text/javascript" src="${ctxStatic}/verify/js/jquery-1.11.0.min.js"></script>
	<script type="text/javascript" src="${ctxStatic}/verify/js/verify.js"></script>
	<script type="text/javascript">
		var isok=false;
		$('#validateCode').codeVerify({
			type : 2,
